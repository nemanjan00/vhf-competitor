...
| 17 | Ground station tier: headless real-time box at mast base does channelization, demod, skimming, recording, and **NPU AI noise cancelling**; operator position is a thin client | **considering** | Masthead FPGA stays near-stock (safety jobs only); NPU hardware and NR domain (audio vs IQ) open. See [04-dsp-partitioning.md](04-dsp-partitioning.md) |
